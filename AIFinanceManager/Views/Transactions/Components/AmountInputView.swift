...
// Состояние символа для анимации
...
struct AnimatedDigit: View {
    ...
    @State private var previousIsNew: Bool = false
    ...
    var body: some View {
        Text(String(character))
            ...
            .onAppear {
                if isNew {
                    // Новый символ - запускаем анимацию сразу
                    animateAppearance()
                } else {
                    // Существующий символ - без анимации
                    offset = 0
                    scale = 1.0
                    rotation = 0
                }
    ...
    private func animateAppearance() {
        // Сбрасываем состояние для новой анимации
        offset = 20
        scale = 0.5
        rotation = 0
        ...
        // Wobble эффект - покачивание влево-вправо
        DispatchQueue.main.asyncAfter(deadline: .now() + 0.1) {
...
// PreferenceKey для передачи ширины контейнера
